...
def main(data_path: Path) -> None:
    ...
    model = make_pipeline(
        ...
        RandomForestRegressor(n_estimators=300, random_state=42, n_jobs=-1, min_samples_leaf=2),
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Predict laser power with a random forest.")
